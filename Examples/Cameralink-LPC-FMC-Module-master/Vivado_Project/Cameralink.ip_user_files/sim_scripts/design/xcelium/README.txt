...
#
# Generated by export_simulation on Tue Jun 13 12:01:05 +0300 2023
#
################################################################################
...
'-reset_run' switch to the './design.sh' script.
...
./design.sh -noclean_files

For more information on the script, please type './design.sh -help'.
