...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set XADC_GPIO_0 [ create_bd_port -dir O XADC_GPIO_0 ]
  set XADC_GPIO_1 [ create_bd_port -dir O XADC_GPIO_1 ]
  set XADC_GPIO_2 [ create_bd_port -dir O XADC_GPIO_2 ]
  set XADC_GPIO_3 [ create_bd_port -dir O XADC_GPIO_3 ]
  ...
  connect_bd_net -net AD5065_Dual_DAC_AXI_0_ldac [get_bd_ports XADC_GPIO_0] [get_bd_pins AD5065_Dual_DAC_AXI_0/ldac]
  connect_bd_net -net AD5065_Dual_DAC_AXI_0_mosi [get_bd_ports XADC_GPIO_2] [get_bd_pins AD5065_Dual_DAC_AXI_0/mosi]
  connect_bd_net -net AD5065_Dual_DAC_AXI_0_sclk [get_bd_ports XADC_GPIO_1] [get_bd_pins AD5065_Dual_DAC_AXI_0/sclk]
  connect_bd_net -net AD5065_Dual_DAC_AXI_0_sync [get_bd_ports XADC_GPIO_3] [get_bd_pins AD5065_Dual_DAC_AXI_0/sync]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins AD5065_Dual_DAC_AXI_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AD5065_Dual_DAC_AXI_0/s00_axi/reg0] -force
