...
fpga -file C:/Users/Work/Downloads/Xilinx/Projects/vitis/test/_ide/bitstream/DAC_XADC_TestPlatform.bit
targets -set -nocase -filter {name =~"APU*"}
...
targets -set -nocase -filter {name =~"APU*"}
source C:/Users/Work/Downloads/Xilinx/Projects/vitis/test/_ide/psinit/ps7_init.tcl
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "*A9*#0"}
dow C:/Users/Work/Downloads/Xilinx/Projects/vitis/test/Debug/test.elf
